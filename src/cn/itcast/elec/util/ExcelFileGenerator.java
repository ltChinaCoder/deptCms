...
public class ExcelFileGenerator {
	...
	private final int SPLIT_COUNT = 1500; //Excel姣忎釜宸ヤ綔绨跨殑琛屾暟

	private ArrayList fieldName = null; //excel鏍囬鏁版嵁闆�

	private ArrayList fieldData = null; //excel鏁版嵁鍐呭	

	private HSSFWorkbook workBook = null;

	/**
	 * 鏋勯�鍣�
	 * @param fieldName 缁撴灉闆嗙殑瀛楁鍚�
	 * @param data
	 */
